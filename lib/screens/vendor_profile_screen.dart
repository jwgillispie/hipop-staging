...
class _VendorProfileScreenState extends State<VendorProfileScreen> {
  ...
  Future<void> _deleteAccount() async {
    ...
    try {
      ...
      await _profileService.deleteUserProfile(user.uid);

      // TODO: Delete vendor posts, favorites, and other related data
      // This would typically be handled by a cloud function with cascading deletes
        ...
        return AlertDialog(
          ...
          content: const Column(
            ...
            children: [
              ...
              SizedBox(height: 8),
              Text('• Delete all your pop-up events'),
              Text('• Remove your vendor profile'),
