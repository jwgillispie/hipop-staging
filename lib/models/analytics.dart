...
class MarketAnalytics extends Equatable {
  ...
  final int featuredRecipes;
  final int totalRecipeLikes;
  ...
  const MarketAnalytics({
    ...
    this.totalRecipes = 0,
    this.publicRecipes = 0,
    this.featuredRecipes = 0,
  ...
  factory MarketAnalytics.fromFirestore(DocumentSnapshot doc) {
    ...
    return MarketAnalytics(
      ...
      publicRecipes: data['publicRecipes'] ?? 0,
      featuredRecipes: data['featuredRecipes'] ?? 0,
