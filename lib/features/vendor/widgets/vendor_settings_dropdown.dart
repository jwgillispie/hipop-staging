...
class VendorSettingsDropdown extends StatefulWidget {
  const VendorSettingsDropdown({super.key});

  @override
  State<VendorSettingsDropdown> createState() => _VendorSettingsDropdownState();
}

class _VendorSettingsDropdownState extends State<VendorSettingsDropdown> {
  ...
  void _showFeedbackDialog() {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: const Text('Send Vendor Feedback'),
        content: SingleChildScrollView(
          child: StatefulBuilder(
            builder: (context, setState) => Column(
              ...
              children: [
                Text(
                  'Help us improve the vendor experience! Your feedback goes directly to our team.',
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Title',
                    hintText: 'Brief summary of your vendor feedback',
                    border: OutlineInputBorder(),
                  ),
                  maxLength: 200,
                ),
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    hintText: 'Please provide details about your vendor experience',
                    border: OutlineInputBorder(),
                  ),
                  maxLines: 4,
                  maxLength: 2000,
  ...
  Future<void> _submitFeedback(FeedbackCategory category, String title, String description) async {
    try {
      ...
      await UserFeedbackService.submitFeedback(
        ...
        metadata: {
          'screen': 'vendor_settings_dropdown',
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Thank you for your vendor feedback! We\'ll review it soon.'),
            backgroundColor: Colors.green,
          ),
        );
      }
      ...
      onSelected: (String value) {
        switch (value) {
          ...
          case 'logout':
            ...
            break;
          case 'delete':
            SpecializedAccountDeletionService.deleteVendorAccount(context);
            break;
        }
      },
